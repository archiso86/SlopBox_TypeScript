...
import { ChordProgressionPrompt } from "./ChordProgressionPrompt";
...
export class SongEditor {
    ...
    */
        ...
        if (promptName) {
            switch (promptName) {
                ...
                case "generateEuclideanRhythm":
                    ...
                    break;
                case "writeChordProgression":
                    this.prompt = new ChordProgressionPrompt(this.doc);
                    break;
                case "customTheme":
    ...
    private _whenSetSoundFontForceOneshot = (): void => {
        this.doc.record(new ChangeSoundFontForceOneshot(this.doc, this._soundFontForceOneshotBox.checked));
    }
